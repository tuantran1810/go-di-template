...
// CreateMany provides a mock function for the type MockIMessageRepository
func (_mock *MockIMessageRepository) CreateMany(ctx context.Context, tx entities.Transaction, messages []entities.Message) ([]entities.Message, error) {
...
// MockIMessageRepository_CreateMany_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateMany'
type MockIMessageRepository_CreateMany_Call struct {
	*mock.Call
}
...
//   - tx
//   - messages
func (_e *MockIMessageRepository_Expecter) CreateMany(ctx interface{}, tx interface{}, messages interface{}) *MockIMessageRepository_CreateMany_Call {
	return &MockIMessageRepository_CreateMany_Call{Call: _e.mock.On("CreateMany", ctx, tx, messages)}
}

func (_c *MockIMessageRepository_CreateMany_Call) Run(run func(ctx context.Context, tx entities.Transaction, messages []entities.Message)) *MockIMessageRepository_CreateMany_Call {
...
func (_c *MockIMessageRepository_CreateMany_Call) Return(messages1 []entities.Message, err error) *MockIMessageRepository_CreateMany_Call {
	_c.Call.Return(messages1, err)
	return _c
}

func (_c *MockIMessageRepository_CreateMany_Call) RunAndReturn(run func(ctx context.Context, tx entities.Transaction, messages []entities.Message) ([]entities.Message, error)) *MockIMessageRepository_CreateMany_Call {
	_c.Call.Return(run)
	return _c
}
